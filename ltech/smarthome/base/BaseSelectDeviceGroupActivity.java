...
public abstract class BaseSelectDeviceGroupActivity extends BaseList2Activity<Role> implements TextWatcher {
    ...
    protected boolean canSelectRoom = true;
    ...
    protected void initView() {
        ...
        ((ActSelect2Binding) this.mViewBinding).searchBar.ivClean.setOnClickListener(new View.OnClickListener() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ((ActSelect2Binding) BaseSelectDeviceGroupActivity.this.mViewBinding).searchBar.searchEdtTxt.setText("");
            }
        });
    }
    ...
    /* renamed from: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity$2, reason: invalid class name */
    class AnonymousClass2 implements Observer<Resource<List<Floor>>> {
        ...
        public void onChanged(Resource<List<Floor>> listResource) {
            BaseSelectDeviceGroupActivity.this.handleResource(listResource, new IAction() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity$2$$ExternalSyntheticLambda0
                @Override // com.ltech.smarthome.base.IAction
                public final void act(Object obj) {
                    BaseSelectDeviceGroupActivity.AnonymousClass2.this.lambda$onChanged$0((List) obj);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onChanged$0(List list) {
            ...
            floor.setFloorName(BaseSelectDeviceGroupActivity.this.getString(R.string.all_floor));
            floor.setFloorId(-1L);
            floor.setPlaceId(BaseSelectDeviceGroupActivity.this.placeId);
            list.add(0, floor);
            BaseSelectDeviceGroupActivity.this.floorList = list;
            if (!BaseSelectDeviceGroupActivity.this.canSelectRoom) {
                BaseSelectDeviceGroupActivity baseSelectDeviceGroupActivity = BaseSelectDeviceGroupActivity.this;
                baseSelectDeviceGroupActivity.setCurFloor(baseSelectDeviceGroupActivity.checkFloor(list));
            }
            BaseSelectDeviceGroupActivity.this.initFloorSpinner();
        }
    }
    ...
    protected void startObserve() {
        ...
        this.selectRoom.addSource(Transformations.switchMap(this.selectFloor, new Function1() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                LiveData lambda$startObserve$0;
                lambda$startObserve$0 = BaseSelectDeviceGroupActivity.this.lambda$startObserve$0((Floor) obj);
                return lambda$startObserve$0;
            }
        }), new Observer() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity$$ExternalSyntheticLambda2
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                BaseSelectDeviceGroupActivity.this.lambda$startObserve$2((Resource) obj);
            }
        });
        this.roleList = Transformations.switchMap(this.selectRoom, new Function1<Room, LiveData<Resource<List<Role>>>>() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.3
            @Override // kotlin.jvm.functions.Function1
            public LiveData<Resource<List<Role>>> invoke(Room room) {
                ...
                List<Device> deviceListByRoomIdFromDb = Injection.repo().device().getDeviceListByRoomIdFromDb(BaseSelectDeviceGroupActivity.this.placeId, BaseSelectDeviceGroupActivity.this.getCurRoom().getFloorId(), BaseSelectDeviceGroupActivity.this.getCurRoom().getRoomId());
                List<Group> groupListByRoomIdFromDb = Injection.repo().group().getGroupListByRoomIdFromDb(BaseSelectDeviceGroupActivity.this.placeId, BaseSelectDeviceGroupActivity.this.getCurRoom().getFloorId(), BaseSelectDeviceGroupActivity.this.getCurRoom().getRoomId());
                arrayList.addAll(deviceListByRoomIdFromDb);
                arrayList.addAll(groupListByRoomIdFromDb);
                Collections.sort(arrayList, new Comparator<Role>(this) { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.3.1
    ...
    public /* synthetic */ void lambda$startObserve$2(Resource resource) {
        handleResource(resource, new IAction() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity$$ExternalSyntheticLambda0
            @Override // com.ltech.smarthome.base.IAction
            public final void act(Object obj) {
                BaseSelectDeviceGroupActivity.this.lambda$startObserve$1((List) obj);
            }
        });
    }
    ...
    public void initFloorSpinner() {
        ...
        ((ActSelect2Binding) this.mViewBinding).spinnerFloor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.4
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!BaseSelectDeviceGroupActivity.this.floorList.get(position).equals(BaseSelectDeviceGroupActivity.this.selectFloor.getValue())) {
                    BaseSelectDeviceGroupActivity baseSelectDeviceGroupActivity = BaseSelectDeviceGroupActivity.this;
                    baseSelectDeviceGroupActivity.setCurFloor(baseSelectDeviceGroupActivity.floorList.get(position));
                }
                deviceManagerSpinnerAdapter.setSelectPosition(position);
                SPUtils.getInstance().put(Constants.USER_CUR_FLOOR, BaseSelectDeviceGroupActivity.this.selectFloor.getValue().getFloorId());
            }
        });
    ...
    private void initRoomSpinner() {
        ...
        ((ActSelect2Binding) this.mViewBinding).spinnerRoom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.5
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onNothingSelected(AdapterView<?> parent) {
            }
            ...
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!BaseSelectDeviceGroupActivity.this.roomList.get(position).equals(BaseSelectDeviceGroupActivity.this.selectRoom.getValue())) {
                    BaseSelectDeviceGroupActivity baseSelectDeviceGroupActivity = BaseSelectDeviceGroupActivity.this;
                    baseSelectDeviceGroupActivity.setCurRoom(baseSelectDeviceGroupActivity.roomList.get(position));
                }
                deviceManagerSpinnerAdapter.setSelectPosition(position);
                SPUtils.getInstance().put(Constants.USER_CUR_ROOM, BaseSelectDeviceGroupActivity.this.selectRoom.getValue().getRoomId());
            }
        });
    ...
    public void search(final String keyword) {
        ((ObservableSubscribeProxy) Observable.create(new ObservableOnSubscribe<List<Role>>() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.7
            ...
            public void subscribe(ObservableEmitter<List<Role>> emitter) throws Exception {
                ...
                this.inSearchMode = z;
                if (z) {
                    for (Role role : BaseSelectDeviceGroupActivity.this.allData) {
                        if (role.getName().toLowerCase().contains(keyword.toLowerCase())) {
                            arrayList.add(role);
                        }
                    }
                } else {
                    arrayList.addAll(BaseSelectDeviceGroupActivity.this.allData);
                }
                emitter.onNext(arrayList);
                emitter.onComplete();
            }
        }).compose(RxUtils.io_main()).as(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(this, Lifecycle.Event.ON_DESTROY)))).subscribe(new DisposableObserver<List<Role>>() { // from class: com.ltech.smarthome.base.BaseSelectDeviceGroupActivity.6
            ...
            public void onNext(List<Role> items) {
                BaseSelectDeviceGroupActivity.this.refreshData.setValue(items);
            }
        });
    }
}