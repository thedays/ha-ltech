...
public abstract class BaseSelectDeviceAndGroupDivideActivity extends BaseSelectDivideListActivity<Role> {
    public LiveData<Resource<List<Role>>> deviceResult;
    ...
    public MediatorLiveData<Role> deviceMediatorLiveData = new MediatorLiveData<>();
    ...
    protected void startObserve() {
        this.selectFloor.observe(this, new Observer<Floor>() { // from class: com.ltech.smarthome.base.BaseSelectDeviceAndGroupDivideActivity.1
            @Override // androidx.lifecycle.Observer
            public void onChanged(Floor floor) {
                List<Room> roomListByFloorId = Injection.repo().home().getRoomListByFloorId(BaseSelectDeviceAndGroupDivideActivity.this.placeId, floor.getFloorId());
                if (BaseSelectDeviceAndGroupDivideActivity.this.mRoomList.size() == roomListByFloorId.size() + 1) {
                    return;
                }
                Room room = new Room();
                room.setRoomName(BaseSelectDeviceAndGroupDivideActivity.this.getString(R.string.all_room));
                room.setRoomId(-1L);
                room.setFloorId(BaseSelectDeviceAndGroupDivideActivity.this.selectFloor.getValue().getFloorId());
                room.setPlaceId(BaseSelectDeviceAndGroupDivideActivity.this.placeId);
                roomListByFloorId.add(0, room);
                BaseSelectDeviceAndGroupDivideActivity.this.mRoomList = roomListByFloorId;
                BaseSelectDeviceAndGroupDivideActivity baseSelectDeviceAndGroupDivideActivity = BaseSelectDeviceAndGroupDivideActivity.this;
                baseSelectDeviceAndGroupDivideActivity.setCurRoom(baseSelectDeviceAndGroupDivideActivity.checkRoom(roomListByFloorId));
                BaseSelectDeviceAndGroupDivideActivity.this.initRoomSpinner();
            }
        });
        ...
        initFloorSpinner();
        this.deviceResult = Transformations.switchMap(this.selectRoom, new Function1() { // from class: com.ltech.smarthome.base.BaseSelectDeviceAndGroupDivideActivity$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                LiveData lambda$startObserve$0;
                lambda$startObserve$0 = BaseSelectDeviceAndGroupDivideActivity.this.lambda$startObserve$0((Room) obj);
    ...
    public /* synthetic */ LiveData lambda$startObserve$0(Room room) {
        ...
        List<Group> groupListByRoomIdFromDb = Injection.repo().group().getGroupListByRoomIdFromDb(this.placeId, getCurRoom().getFloorId(), getCurRoom().getRoomId());
    ...
    protected String getPlaceInfo(long floorId, long roomId) {
        ...
        List<Floor> list = this.mTotalFloorList;
        if (list != null) {
        ...
        List<Room> list2 = this.mTotalRoomList;
        if (list2 != null) {
    ...
    private void initFloorSpinner() {
        ...
        ((ActSelectDivideBinding) this.mViewBinding).spinnerFloor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.ltech.smarthome.base.BaseSelectDeviceAndGroupDivideActivity.2
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!BaseSelectDeviceAndGroupDivideActivity.this.mFloorList.get(position).equals(BaseSelectDeviceAndGroupDivideActivity.this.selectFloor.getValue())) {
                    BaseSelectDeviceAndGroupDivideActivity baseSelectDeviceAndGroupDivideActivity = BaseSelectDeviceAndGroupDivideActivity.this;
                    baseSelectDeviceAndGroupDivideActivity.setCurFloor(baseSelectDeviceAndGroupDivideActivity.mFloorList.get(position));
                }
                if (position == 0) {
                    BaseSelectDeviceAndGroupDivideActivity.this.mTotalFloorList.addAll(BaseSelectDeviceAndGroupDivideActivity.this.mFloorList.subList(1, BaseSelectDeviceAndGroupDivideActivity.this.mFloorList.size()));
                }
    ...
    public void initRoomSpinner() {
        ...
        ((ActSelectDivideBinding) this.mViewBinding).spinnerRoom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() { // from class: com.ltech.smarthome.base.BaseSelectDeviceAndGroupDivideActivity.3
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onNothingSelected(AdapterView<?> parent) {
            }
            ...
            @Override // android.widget.AdapterView.OnItemSelectedListener
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!BaseSelectDeviceAndGroupDivideActivity.this.mRoomList.get(position).equals(BaseSelectDeviceAndGroupDivideActivity.this.selectRoom.getValue())) {
                    BaseSelectDeviceAndGroupDivideActivity baseSelectDeviceAndGroupDivideActivity = BaseSelectDeviceAndGroupDivideActivity.this;
                    baseSelectDeviceAndGroupDivideActivity.setCurRoom(baseSelectDeviceAndGroupDivideActivity.mRoomList.get(position));
                }
                if (position == 0) {
                    BaseSelectDeviceAndGroupDivideActivity.this.mTotalRoomList.addAll(BaseSelectDeviceAndGroupDivideActivity.this.mRoomList.subList(1, BaseSelectDeviceAndGroupDivideActivity.this.mRoomList.size()));
                }
                deviceManagerSpinnerAdapter.setSelectPosition(position);
            }
        });
    ...
    protected List<Role> getSelectList() {
        return new ArrayList();
    }

    @Override // com.ltech.smarthome.base.BaseSelectDivideListActivity
    protected List<Role> getNotSelectList() {
        return new ArrayList();
    }
}