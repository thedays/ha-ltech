...
public class ItemGroupManageBindingImpl extends ItemGroupManageBinding {
    ...
    public ItemGroupManageBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ItemGroupManageBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ltech.smarthome.databinding.ItemGroupManageBinding
    ...
    protected void executeBindings() {
        ...
        long j3 = 18 & j;
        String groupName = (j3 == 0 || group == null) ? null : group.getGroupName();
        long j4 = 20 & j;
        long j5 = 24 & j;
        if (j2 != 0) {
