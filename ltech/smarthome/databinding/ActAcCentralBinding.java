...
public abstract class ActAcCentralBinding extends ViewDataBinding {
    ...
    public static ActAcCentralBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcCentralBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActAcCentralBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_ac_central, root, attachToRoot, component);
    }

    public static ActAcCentralBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcCentralBinding inflate(LayoutInflater inflater, Object component) {
        return (ActAcCentralBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_ac_central, null, false, component);
    }

    public static ActAcCentralBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcCentralBinding bind(View view, Object component) {
        return (ActAcCentralBinding) bind(component, view, R.layout.act_ac_central);
    }
}