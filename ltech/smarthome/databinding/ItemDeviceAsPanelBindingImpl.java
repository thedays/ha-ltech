...
public class ItemDeviceAsPanelBindingImpl extends ItemDeviceAsPanelBinding {
    ...
    public ItemDeviceAsPanelBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }

    private ItemDeviceAsPanelBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[6], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[9], (LinearLayoutCompat) bindings[7], (AppCompatImageView) bindings[8], (AppCompatImageView) bindings[3], (ConstraintLayout) bindings[1], (View) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemDeviceAsPanelBinding
