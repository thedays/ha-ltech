...
public class FtBindMailBindingImpl extends FtBindMailBinding {
    ...
    public FtBindMailBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 18, sIncludes, sViewsWithIds));
    }

    private FtBindMailBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 7, (Button) bindings[10], (TextInputEditText) bindings[4], (TextInputEditText) bindings[2], (TextInputEditText) bindings[7], (TextInputEditText) bindings[5], (AppCompatImageView) bindings[8], (AppCompatImageView) bindings[3], (LayoutProtocolDefaultBinding) bindings[13], (TextView) bindings[14], (TextInputLayout) bindings[15], (TextInputLayout) bindings[1], (TextInputLayout) bindings[17], (TextInputLayout) bindings[16], (LayoutTitleDefaultBinding) bindings[12], (AppCompatTextView) bindings[11], (AppCompatTextView) bindings[9], (AppCompatTextView) bindings[6]);
        this.etAccountandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.FtBindMailBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                ObservableField<String> observableField;
                String textString = TextViewBindingAdapter.getTextString(FtBindMailBindingImpl.this.etAccount);
                FtBindMailVM ftBindMailVM = FtBindMailBindingImpl.this.mViewmodel;
                if (ftBindMailVM == null || (observableField = ftBindMailVM.account) == null) {
                    return;
                }
                observableField.set(textString);
            }
        };
        this.etCountryandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.FtBindMailBindingImpl.2
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                ObservableField<String> observableField;
                String textString = TextViewBindingAdapter.getTextString(FtBindMailBindingImpl.this.etCountry);
                FtBindMailVM ftBindMailVM = FtBindMailBindingImpl.this.mViewmodel;
                if (ftBindMailVM == null || (observableField = ftBindMailVM.country) == null) {
                    return;
                }
                observableField.set(textString);
            }
        };
        this.etPwdandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.FtBindMailBindingImpl.3
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                ObservableField<String> observableField;
                String textString = TextViewBindingAdapter.getTextString(FtBindMailBindingImpl.this.etPwd);
                FtBindMailVM ftBindMailVM = FtBindMailBindingImpl.this.mViewmodel;
                if (ftBindMailVM == null || (observableField = ftBindMailVM.password) == null) {
                    return;
                }
                observableField.set(textString);
            }
        };
        this.etVerificationandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.FtBindMailBindingImpl.4
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                ObservableField<String> observableField;
                String textString = TextViewBindingAdapter.getTextString(FtBindMailBindingImpl.this.etVerification);
                FtBindMailVM ftBindMailVM = FtBindMailBindingImpl.this.mViewmodel;
                if (ftBindMailVM == null || (observableField = ftBindMailVM.verificationCode) == null) {
                    return;
                }
                observableField.set(textString);
            }
        };
        this.tvErrorTipandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.FtBindMailBindingImpl.5
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                ObservableField<String> observableField;
                String textString = TextViewBindingAdapter.getTextString(FtBindMailBindingImpl.this.tvErrorTip);
                FtBindMailVM ftBindMailVM = FtBindMailBindingImpl.this.mViewmodel;
                if (ftBindMailVM == null || (observableField = ftBindMailVM.error_tips) == null) {
                    return;
                }
                observableField.set(textString);
            }
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((FtBindMailVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.FtBindMailBinding
    ...
    @Override // com.ltech.smarthome.databinding.FtBindMailBinding
    public void setViewmodel(FtBindMailVM Viewmodel) {
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.FtBindMailBindingImpl.executeBindings():void");
    }
}