...
public class FtLocalSceneBindingImpl extends FtLocalSceneBinding {
    ...
    public FtLocalSceneBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FtLocalSceneBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ltech.smarthome.databinding.FtLocalSceneBinding
    ...
    protected void executeBindings() {
        ...
        FtSceneVM ftSceneVM = this.mViewmodel;
        long j2 = j & 6;
        RecyclerView.ItemDecoration itemDecoration = (j2 == 0 || ftSceneVM == null) ? null : ftSceneVM.decoration;
        if (j2 != 0) {
            ViewAdapter.addItemDecoration(this.rv, itemDecoration);
        }
