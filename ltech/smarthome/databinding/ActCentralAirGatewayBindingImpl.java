...
public class ActCentralAirGatewayBindingImpl extends ActCentralAirGatewayBinding {
    ...
    public ActCentralAirGatewayBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }

    private ActCentralAirGatewayBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActCentralAirGatewayVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActCentralAirGatewayBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActCentralAirGatewayBinding
    public void setViewmodel(ActCentralAirGatewayVM Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        ActCentralAirGatewayVM actCentralAirGatewayVM = this.mViewmodel;
        long j2 = 5 & j;
        long j3 = 6 & j;
        BindingCommand<View> bindingCommand = (j3 == 0 || actCentralAirGatewayVM == null) ? null : actCentralAirGatewayVM.viewClick;
        if (j3 != 0) {
