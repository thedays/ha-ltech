...
public class DialogNumberEditBindingImpl extends DialogNumberEditBinding {
    private static final ViewDataBinding.IncludedLayouts sIncludes = null;
    private static final SparseIntArray sViewsWithIds = null;
    private InverseBindingListener etContentandroidTextAttrChanged;
    private long mDirtyFlags;

    public DialogNumberEditBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private DialogNumberEditBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatEditText) bindings[2], (AppCompatImageView) bindings[3], (LinearLayout) bindings[0], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[1]);
        this.etContentandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.DialogNumberEditBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                String textString = TextViewBindingAdapter.getTextString(DialogNumberEditBindingImpl.this.etContent);
                ObservableField<String> observableField = DialogNumberEditBindingImpl.this.mContent;
    ...
    @Override // com.ltech.smarthome.databinding.DialogNumberEditBinding
    ...
    */
    protected void executeBindings() {
        ...
        L35:
            ...
            if (r12 == 0) goto L49
            androidx.appcompat.widget.AppCompatEditText r6 = r14.etContent
            androidx.databinding.adapters.TextViewBindingAdapter.setText(r6, r4)
            androidx.appcompat.widget.AppCompatImageView r4 = r14.ivDelete
            r4.setVisibility(r8)
        L49:
            r6 = 4
            long r0 = r0 & r6
            ...
            androidx.appcompat.widget.AppCompatTextView r0 = r14.tvError
            r1 = 1
        ...
        L6b:
            if (r9 == 0) goto L7c
            androidx.appcompat.widget.AppCompatImageView r0 = r14.ivDelete
            ...
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r0, r5, r11)
            androidx.appcompat.widget.AppCompatTextView r0 = r14.tvOk
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r0, r5, r11)
        L7c:
            return
        L7d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogNumberEditBindingImpl.executeBindings():void");
    }
}