...
public class DialogTimeSelectorWithLimitBindingImpl extends DialogTimeSelectorWithLimitBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.iv_select, 9);
        sparseIntArray.put(R.id.layout_select, 10);
        sparseIntArray.put(R.id.pick_view_min, 11);
        sparseIntArray.put(R.id.picker_view_sec, 12);
        sparseIntArray.put(R.id.iv_select2, 13);
    }

    public DialogTimeSelectorWithLimitBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private DialogTimeSelectorWithLimitBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[9], (AppCompatImageView) bindings[13], (RelativeLayout) bindings[4], (RelativeLayout) bindings[7], (ConstraintLayout) bindings[10], (RecyclerView) bindings[11], (RecyclerView) bindings[12], (AppCompatTextView) bindings[1], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[8], (AppCompatTextView) bindings[2]);
        this.mDirtyFlags = -1L;
        this.layoutChooseOne.setTag(null);
        this.layoutChooseTwo.setTag(null);
    ...
    @Override // com.ltech.smarthome.databinding.DialogTimeSelectorWithLimitBinding
    ...
    */
    protected void executeBindings() {
        ...
        L30:
            ...
            if (r16 == 0) goto L55
            android.widget.RelativeLayout r11 = r1.layoutChooseOne
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r11, r8, r13)
            android.widget.RelativeLayout r11 = r1.layoutChooseTwo
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r11, r8, r13)
        ...
        L8a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogTimeSelectorWithLimitBindingImpl.executeBindings():void");
    }
}