...
public abstract class ActNewScreenPanelBinding extends ViewDataBinding {
    ...
    public static ActNewScreenPanelBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActNewScreenPanelBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActNewScreenPanelBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_new_screen_panel, root, attachToRoot, component);
    }

    public static ActNewScreenPanelBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActNewScreenPanelBinding inflate(LayoutInflater inflater, Object component) {
        return (ActNewScreenPanelBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_new_screen_panel, null, false, component);
    }

    public static ActNewScreenPanelBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActNewScreenPanelBinding bind(View view, Object component) {
        return (ActNewScreenPanelBinding) bind(component, view, R.layout.act_new_screen_panel);
    }
}