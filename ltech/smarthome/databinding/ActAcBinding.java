...
public abstract class ActAcBinding extends ViewDataBinding {
    ...
    public static ActAcBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActAcBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_ac, root, attachToRoot, component);
    }

    public static ActAcBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcBinding inflate(LayoutInflater inflater, Object component) {
        return (ActAcBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_ac, null, false, component);
    }

    public static ActAcBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActAcBinding bind(View view, Object component) {
        return (ActAcBinding) bind(component, view, R.layout.act_ac);
    }
}