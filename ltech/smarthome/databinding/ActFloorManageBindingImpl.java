...
public class ActFloorManageBindingImpl extends ActFloorManageBinding {
    ...
    public ActFloorManageBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private ActFloorManageBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActFloorManageVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActFloorManageBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActFloorManageBinding
    public void setViewmodel(ActFloorManageVM Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        ActFloorManageVM actFloorManageVM = this.mViewmodel;
        long j2 = 10 & j;
        OnItemBindClass<Object> onItemBindClass2 = null;
        MergeObservableList<Object> mergeObservableList2 = null;
        long j3 = j & 13;
        if (j3 != 0) {
            if (actFloorManageVM != null) {
                onItemBindClass = actFloorManageVM.itemBinding;
                MergeObservableList<Object> mergeObservableList3 = actFloorManageVM.mMergeObservableList;
                itemIds2 = actFloorManageVM.itemIds;
