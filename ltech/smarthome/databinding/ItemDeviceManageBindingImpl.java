...
public class ItemDeviceManageBindingImpl extends ItemDeviceManageBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_dali, 5);
        sparseIntArray.put(R.id.iv_go, 6);
    }

    public ItemDeviceManageBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private ItemDeviceManageBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[6], (AppCompatImageView) bindings[1], (ConstraintLayout) bindings[0], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[4]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemDeviceManageBinding
