...
public abstract class ItemDeviceSceneBinding extends ViewDataBinding {
    ...
    public static ItemDeviceSceneBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSceneBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ItemDeviceSceneBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_scene, root, attachToRoot, component);
    }

    public static ItemDeviceSceneBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSceneBinding inflate(LayoutInflater inflater, Object component) {
        return (ItemDeviceSceneBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_scene, null, false, component);
    }

    public static ItemDeviceSceneBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSceneBinding bind(View view, Object component) {
        return (ItemDeviceSceneBinding) bind(component, view, R.layout.item_device_scene);
    }
}