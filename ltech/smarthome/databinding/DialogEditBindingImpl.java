...
public class DialogEditBindingImpl extends DialogEditBinding {
    ...
    public DialogEditBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private DialogEditBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatEditText) bindings[2], (AppCompatImageView) bindings[3], (LinearLayout) bindings[0], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[1]);
        this.etContentandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.DialogEditBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                String textString = TextViewBindingAdapter.getTextString(DialogEditBindingImpl.this.etContent);
                ObservableField<String> observableField = DialogEditBindingImpl.this.mContent;
    ...
    @Override // com.ltech.smarthome.databinding.DialogEditBinding
    ...
    */
    protected void executeBindings() {
        ...
        L78:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogEditBindingImpl.executeBindings():void");
    }
}