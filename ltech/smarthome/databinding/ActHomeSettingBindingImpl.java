...
public class ActHomeSettingBindingImpl extends ActHomeSettingBinding {
    ...
    public ActHomeSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ActHomeSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (RecyclerView) bindings[1], (SmartRefreshLayout) bindings[3], (LayoutTitleDefaultBinding) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActHomeSettingVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActHomeSettingBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActHomeSettingBinding
    public void setViewmodel(ActHomeSettingVM Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        ActHomeSettingVM actHomeSettingVM = this.mViewmodel;
        long j2 = 10 & j;
        OnItemBindClass<Object> onItemBindClass2 = null;
        MergeObservableList<Object> mergeObservableList2 = null;
        long j3 = j & 13;
        if (j3 != 0) {
            if (actHomeSettingVM != null) {
                MergeObservableList<Object> mergeObservableList3 = actHomeSettingVM.mergeObservableList;
                onItemBindClass = actHomeSettingVM.itemBinding;
                itemIds2 = actHomeSettingVM.itemIds;
