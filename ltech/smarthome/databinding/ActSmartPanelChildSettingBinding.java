...
public abstract class ActSmartPanelChildSettingBinding extends ViewDataBinding {
    ...
    @Bindable
    protected ActSmartPanelChildSettingVM mViewmodel;
    ...
    public abstract void setViewmodel(ActSmartPanelChildSettingVM viewmodel);

    protected ActSmartPanelChildSettingBinding(Object _bindingComponent, View _root, int _localFieldCount, NestedScrollView actAddDeviceScroll, AppCompatImageView ivIcon, AppCompatImageView ivRoomNameGo, AppCompatImageView ivSceneGo, AppCompatImageView ivSceneNameGo, AppCompatImageView ivSubDeviceNameGo, RelativeLayout layoutChangeIcon, ConstraintLayout layoutChangeRoom, RelativeLayout layoutSceneAndAutomation, ConstraintLayout layoutSceneName, ConstraintLayout layoutSubDevice, SmartRefreshLayout refreshLayout, SwitchButton sbAddToSmart, LayoutTitleDefaultBinding title, AppCompatTextView tvDeviceName, AppCompatTextView tvDeviceTip, AppCompatTextView tvNameTip, AppCompatTextView tvRelatedNum, AppCompatTextView tvRoomName, AppCompatTextView tvRoomTip, AppCompatTextView tvSubordinateDevice) {
    ...
    public ActSmartPanelChildSettingVM getViewmodel() {
        return this.mViewmodel;
    }

    public static ActSmartPanelChildSettingBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSmartPanelChildSettingBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActSmartPanelChildSettingBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_smart_panel_child_setting, root, attachToRoot, component);
    }

    public static ActSmartPanelChildSettingBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSmartPanelChildSettingBinding inflate(LayoutInflater inflater, Object component) {
        return (ActSmartPanelChildSettingBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_smart_panel_child_setting, null, false, component);
    }

    public static ActSmartPanelChildSettingBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSmartPanelChildSettingBinding bind(View view, Object component) {
        return (ActSmartPanelChildSettingBinding) bind(component, view, R.layout.act_smart_panel_child_setting);
    }
}