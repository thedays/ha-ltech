...
public class FtMessageHomeBindingImpl extends FtMessageHomeBinding {
    ...
    public FtMessageHomeBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private FtMessageHomeBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((FtMessageHomeVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.FtMessageHomeBinding
    public void setViewmodel(FtMessageHomeVM Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        FtMessageHomeVM ftMessageHomeVM = this.mViewmodel;
        long j2 = j & 14;
        OnItemBind<Object> onItemBind2 = null;
        MergeObservableList<Object> mergeObservableList2 = null;
        if (j2 != 0) {
            if (ftMessageHomeVM != null) {
                onItemBind = ftMessageHomeVM.itemBinding;
                mergeObservableList2 = ftMessageHomeVM.dataList;
            } else {
                onItemBind = null;
            }
