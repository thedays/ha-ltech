...
public class ActGqxSettingBindingImpl extends ActGqxSettingBinding {
    ...
    public ActGqxSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 74, sIncludes, sViewsWithIds));
    }

    private ActGqxSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        if (92 == variableId) {
            setViewmodel((ActGqxSettingVM) variable);
            return true;
        }
        if (61 != variableId) {
            return false;
    ...
    @Override // com.ltech.smarthome.databinding.ActGqxSettingBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActGqxSettingBinding
    public void setViewmodel(ActGqxSettingVM Viewmodel) {
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.ActGqxSettingBindingImpl.executeBindings():void");
    }
}