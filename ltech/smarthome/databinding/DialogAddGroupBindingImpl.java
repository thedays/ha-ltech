...
public class DialogAddGroupBindingImpl extends DialogAddGroupBinding {
    ...
    public DialogAddGroupBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private DialogAddGroupBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatEditText) bindings[4], (AppCompatImageView) bindings[5], (ConstraintLayout) bindings[0], (LinearLayout) bindings[7], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[1]);
        this.etContentandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.DialogAddGroupBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                String textString = TextViewBindingAdapter.getTextString(DialogAddGroupBindingImpl.this.etContent);
                ObservableField<String> observableField = DialogAddGroupBindingImpl.this.mContent;
    ...
    @Override // com.ltech.smarthome.databinding.DialogAddGroupBinding
    ...
    */
    protected void executeBindings() {
        ...
        L66:
            ...
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r0, r5, r11)
            androidx.appcompat.widget.AppCompatTextView r0 = r14.tvConfirm
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r0, r5, r11)
        L77:
            return
        L78:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogAddGroupBindingImpl.executeBindings():void");
    }
}