...
public class ActInstructSettingBindingImpl extends ActInstructSettingBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_instruct, 13);
        sparseIntArray.put(R.id.tv_bind_main, 14);
        sparseIntArray.put(R.id.tv_bind_sub, 15);
    }

    public ActInstructSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private ActInstructSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[9], (AppCompatImageView) bindings[6], (AppCompatImageView) bindings[3], (ConstraintLayout) bindings[7], (LinearLayout) bindings[4], (LinearLayout) bindings[1], (LayoutTitleDefaultBinding) bindings[11], (AppCompatTextView) bindings[14], (AppCompatTextView) bindings[15], (AppCompatTextView) bindings[10], (AppCompatTextView) bindings[13], (AppCompatTextView) bindings[12]);
        this.mDirtyFlags = -1L;
        this.ivBindGo.setTag(null);
        this.ivInstructGo.setTag(null);
        this.ivNameGo.setTag(null);
        this.layoutBind.setTag(null);
        this.layoutInstruct.setTag(null);
        ...
        AppCompatTextView appCompatTextView3 = (AppCompatTextView) bindings[8];
    ...
    @Override // com.ltech.smarthome.databinding.ActInstructSettingBinding
    ...
    */
    protected void executeBindings() {
        ...
        L2c:
            ...
            if (r9 == 0) goto L4f
            androidx.appcompat.widget.AppCompatImageView r7 = r14.ivBindGo
            r7.setVisibility(r4)
            androidx.appcompat.widget.AppCompatImageView r7 = r14.ivInstructGo
            r7.setVisibility(r4)
        ...
        L4f:
            if (r12 == 0) goto L65
            androidx.constraintlayout.widget.ConstraintLayout r4 = r14.layoutBind
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r4, r5, r11)
            android.widget.LinearLayout r4 = r14.layoutInstruct
            com.ltech.smarthome.binding.view.ViewAdapter.onClickCommand(r4, r5, r11)
        ...
        L8e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.ActInstructSettingBindingImpl.executeBindings():void");
    }
}