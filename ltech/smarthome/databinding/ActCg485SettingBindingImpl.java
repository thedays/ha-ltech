...
public class ActCg485SettingBindingImpl extends ActCg485SettingBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.iv_serial_go, 33);
        sparseIntArray.put(R.id.tv_related_num, 34);
        sparseIntArray.put(R.id.iv_scene_go, 35);
        sparseIntArray.put(R.id.device_replace_go, 36);
        sparseIntArray.put(R.id.device_log_go, 37);
        sparseIntArray.put(R.id.iv_device_id, 38);
        sparseIntArray.put(R.id.iv_mac_address, 39);
        sparseIntArray.put(R.id.iv_product_name, 40);
    }

    public ActCg485SettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 41, sIncludes, sViewsWithIds));
    }

    private ActCg485SettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 6, (AppCompatImageView) bindings[37], (AppCompatImageView) bindings[36], (AppCompatImageView) bindings[29], (AppCompatImageView) bindings[38], (AppCompatImageView) bindings[4], (AppCompatImageView) bindings[39], (AppCompatImageView) bindings[40], (AppCompatImageView) bindings[7], (AppCompatImageView) bindings[35], (AppCompatImageView) bindings[33], (ConstraintLayout) bindings[5], (RelativeLayout) bindings[16], (RelativeLayout) bindings[14], (ConstraintLayout) bindings[1], (RelativeLayout) bindings[12], (RelativeLayout) bindings[19], (RelativeLayout) bindings[22], (RelativeLayout) bindings[10], (ConstraintLayout) bindings[8], (RelativeLayout) bindings[25], (LayoutTitleDefaultBinding) bindings[31], (AppCompatTextView) bindings[30], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[34], (AppCompatTextView) bindings[32], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[9], (AppCompatTextView) bindings[26]);
        this.mDirtyFlags = -1L;
        this.iv.setTag(null);
        ...
        this.layoutSerialParam.setTag(null);
        ...
        AppCompatTextView appCompatTextView7 = (AppCompatTextView) bindings[21];
        ...
        AppCompatTextView appCompatTextView9 = (AppCompatTextView) bindings[24];
        this.mboundView24 = appCompatTextView9;
        appCompatTextView9.setTag(null);
        AppCompatTextView appCompatTextView10 = (AppCompatTextView) bindings[27];
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActCg485SettingVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActCg485SettingBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActCg485SettingBinding
    public void setViewmodel(ActCg485SettingVM Viewmodel) {
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.ActCg485SettingBindingImpl.executeBindings():void");
    }
}