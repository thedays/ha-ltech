...
public class DialogTimeIntervalSelectorBindingImpl extends DialogTimeIntervalSelectorBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.iv_sel_2, 8);
        sparseIntArray.put(R.id.line1, 9);
        sparseIntArray.put(R.id.pick_view_min, 10);
        sparseIntArray.put(R.id.colon1, 11);
        sparseIntArray.put(R.id.picker_view_sec, 12);
        sparseIntArray.put(R.id.pick_view_min2, 13);
        sparseIntArray.put(R.id.colon2, 14);
        sparseIntArray.put(R.id.picker_view_sec2, 15);
        sparseIntArray.put(R.id.line2, 16);
        sparseIntArray.put(R.id.iv_sel_1, 17);
        sparseIntArray.put(R.id.group_time, 18);
    }

    public DialogTimeIntervalSelectorBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 19, sIncludes, sViewsWithIds));
    }

    private DialogTimeIntervalSelectorBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (TextView) bindings[11], (TextView) bindings[14], (Group) bindings[18], (AppCompatImageView) bindings[17], (AppCompatImageView) bindings[8], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[4], (View) bindings[9], (View) bindings[16], (RecyclerView) bindings[10], (RecyclerView) bindings[13], (RecyclerView) bindings[12], (RecyclerView) bindings[15], (AppCompatTextView) bindings[1], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[7], (AppCompatTextView) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.DialogTimeIntervalSelectorBinding
    ...
    */
    protected void executeBindings() {
        ...
        L8a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogTimeIntervalSelectorBindingImpl.executeBindings():void");
    }
}