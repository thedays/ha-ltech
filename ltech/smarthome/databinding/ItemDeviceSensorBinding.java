...
public abstract class ItemDeviceSensorBinding extends ViewDataBinding {
    ...
    public static ItemDeviceSensorBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSensorBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ItemDeviceSensorBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_sensor, root, attachToRoot, component);
    }

    public static ItemDeviceSensorBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSensorBinding inflate(LayoutInflater inflater, Object component) {
        return (ItemDeviceSensorBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_sensor, null, false, component);
    }

    public static ItemDeviceSensorBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSensorBinding bind(View view, Object component) {
        return (ItemDeviceSensorBinding) bind(component, view, R.layout.item_device_sensor);
    }
}