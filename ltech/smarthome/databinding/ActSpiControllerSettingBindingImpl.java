...
public class ActSpiControllerSettingBindingImpl extends ActSpiControllerSettingBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_strip_param, 34);
        sparseIntArray.put(R.id.device_replace_go, 35);
        sparseIntArray.put(R.id.device_log_go, 36);
        sparseIntArray.put(R.id.iv_device_id, 37);
        sparseIntArray.put(R.id.iv_mac_address, 38);
        sparseIntArray.put(R.id.iv_product_name, 39);
    }

    public ActSpiControllerSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 40, sIncludes, sViewsWithIds));
    }

    private ActSpiControllerSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 7, (AppCompatImageView) bindings[36], (AppCompatImageView) bindings[35], (AppCompatImageView) bindings[30], (AppCompatImageView) bindings[37], (AppCompatImageView) bindings[4], (AppCompatImageView) bindings[38], (AppCompatImageView) bindings[39], (AppCompatImageView) bindings[7], (AppCompatImageView) bindings[10], (ConstraintLayout) bindings[5], (RelativeLayout) bindings[17], (RelativeLayout) bindings[15], (ConstraintLayout) bindings[1], (RelativeLayout) bindings[13], (RelativeLayout) bindings[20], (RelativeLayout) bindings[23], (ConstraintLayout) bindings[8], (RelativeLayout) bindings[26], (SwitchButton) bindings[12], (LayoutTitleDefaultBinding) bindings[32], (AppCompatTextView) bindings[31], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[33], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[34], (AppCompatTextView) bindings[9], (AppCompatTextView) bindings[27]);
        this.mDirtyFlags = -1L;
        this.iv.setTag(null);
        this.ivDeviceNameGo.setTag(null);
        this.ivRoomNameGo.setTag(null);
        this.ivStripParamGo.setTag(null);
        ...
        this.layoutStripParam.setTag(null);
        ...
        this.tvStripParamTip.setTag(null);
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActSpiControllerSettingVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActSpiControllerSettingBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActSpiControllerSettingBinding
    public void setViewmodel(ActSpiControllerSettingVM Viewmodel) {
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.ActSpiControllerSettingBindingImpl.executeBindings():void");
    }
}