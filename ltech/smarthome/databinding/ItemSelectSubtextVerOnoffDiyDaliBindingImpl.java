...
public class ItemSelectSubtextVerOnoffDiyDaliBindingImpl extends ItemSelectSubtextVerOnoffDiyDaliBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.cgd_action_view, 5);
    }

    public ItemSelectSubtextVerOnoffDiyDaliBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }

    private ItemSelectSubtextVerOnoffDiyDaliBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (CgdActionSelectView) bindings[5], (AppCompatImageView) bindings[4], (ConstraintLayout) bindings[1], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[3]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemSelectSubtextVerOnoffDiyDaliBinding
