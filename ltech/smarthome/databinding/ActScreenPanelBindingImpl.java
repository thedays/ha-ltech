...
public class ActScreenPanelBindingImpl extends ActScreenPanelBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_tip_title, 14);
        sparseIntArray.put(R.id.tv_tip_message, 15);
    }

    public ActScreenPanelBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }

    private ActScreenPanelBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[8], (AppCompatImageView) bindings[6], (AppCompatImageView) bindings[11], (AppCompatImageView) bindings[12], (AppCompatImageView) bindings[10], (ConstraintLayout) bindings[3], (LinearLayout) bindings[2], (LinearLayout) bindings[4], (LinearLayout) bindings[13], (RecyclerView) bindings[9], (RecyclerView) bindings[7], (LayoutTitleDefaultBinding) bindings[1], (TextView) bindings[15], (TextView) bindings[14], (View) bindings[5]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ActScreenPanelBinding
