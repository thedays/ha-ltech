...
public class DialogAddCg485CategoryBindingImpl extends DialogAddCg485CategoryBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.radio_ble_to_485, 9);
        sparseIntArray.put(R.id.radio_485_to_ble, 10);
        sparseIntArray.put(R.id.view_divider, 11);
        sparseIntArray.put(R.id.rv_color, 12);
        sparseIntArray.put(R.id.group_add, 13);
    }

    public DialogAddCg485CategoryBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 14, sIncludes, sViewsWithIds));
    }

    private DialogAddCg485CategoryBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatEditText) bindings[5], (Group) bindings[13], (AppCompatImageView) bindings[6], (ConstraintLayout) bindings[0], (RadioImageTextView) bindings[10], (RadioImageTextView) bindings[9], (RecyclerView) bindings[12], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[8], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[1], (AppCompatTextView) bindings[7], (View) bindings[11]);
        this.etNameandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.DialogAddCg485CategoryBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                String textString = TextViewBindingAdapter.getTextString(DialogAddCg485CategoryBindingImpl.this.etName);
                ObservableField<String> observableField = DialogAddCg485CategoryBindingImpl.this.mContent;
    ...
    @Override // com.ltech.smarthome.databinding.DialogAddCg485CategoryBinding
    ...
    */
    protected void executeBindings() {
        ...
        L49:
            ...
            androidx.appcompat.widget.AppCompatTextView r0 = r14.tvColor
            r1 = 1
        ...
        L87:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogAddCg485CategoryBindingImpl.executeBindings():void");
    }
}