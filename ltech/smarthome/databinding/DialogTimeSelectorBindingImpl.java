...
public class DialogTimeSelectorBindingImpl extends DialogTimeSelectorBinding {
    ...
    public DialogTimeSelectorBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private DialogTimeSelectorBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (RecyclerView) bindings[6], (RecyclerView) bindings[7], (AppCompatTextView) bindings[1], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.DialogTimeSelectorBinding
    ...
    */
    protected void executeBindings() {
        ...
        L81:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogTimeSelectorBindingImpl.executeBindings():void");
    }
}