...
public class DialogGradualTimeBindingImpl extends DialogGradualTimeBinding {
    ...
    public DialogGradualTimeBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }

    private DialogGradualTimeBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (MyTimePickerView) bindings[8], (MyTimePickerView) bindings[9], (MyTimePickerView) bindings[11], (MyTimePickerView) bindings[10], (AppCompatTextView) bindings[1], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[5], (AppCompatTextView) bindings[7], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.DialogGradualTimeBinding
    ...
    */
    protected void executeBindings() {
        ...
        La6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogGradualTimeBindingImpl.executeBindings():void");
    }
}