...
public class ActMotorPairBindingImpl extends ActMotorPairBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.iv_config_tip, 4);
    }

    public ActMotorPairBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ActMotorPairBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatButton) bindings[2], (AppCompatImageView) bindings[4], (AppCompatTextView) bindings[1]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ActMotorPairBinding
