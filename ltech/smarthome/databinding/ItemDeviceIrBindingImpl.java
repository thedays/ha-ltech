...
public class ItemDeviceIrBindingImpl extends ItemDeviceIrBinding {
    ...
    public ItemDeviceIrBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private ItemDeviceIrBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[7], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[9], (LinearLayoutCompat) bindings[8], (AppCompatImageView) bindings[5], (AppCompatImageView) bindings[3], (ConstraintLayout) bindings[1], (View) bindings[2], (View) bindings[10]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemDeviceIrBinding
    ...
    protected void executeBindings() {
        ...
        if (j2 != 0) {
            ...
            i = z ? 8 : 0;
            i2 = isFavorite ? R.mipmap.ic_favorite : R.mipmap.ic_favorite_default;
            str2 = str;
        } else {
            i = 0;
            i2 = 0;
