...
public class ItemSmartPanelBindingImpl extends ItemSmartPanelBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.tv_virtual, 10);
        sparseIntArray.put(R.id.appCompatTextView17, 11);
        sparseIntArray.put(R.id.tv_write, 12);
    }

    public ItemSmartPanelBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }

    private ItemSmartPanelBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatImageView) bindings[8], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[6], (AppCompatTextView) bindings[11], (LinearLayoutCompat) bindings[9], (AppCompatImageView) bindings[5], (AppCompatImageView) bindings[3], (SmartSwitch) bindings[7], (ConstraintLayout) bindings[1], (AppCompatTextView) bindings[10], (AppCompatTextView) bindings[12], (View) bindings[2]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemSmartPanelBinding
    ...
    */
    protected void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.ItemSmartPanelBindingImpl.executeBindings():void");
    }
}