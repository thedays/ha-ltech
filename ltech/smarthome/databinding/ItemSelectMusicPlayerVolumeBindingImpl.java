...
public class ItemSelectMusicPlayerVolumeBindingImpl extends ItemSelectMusicPlayerVolumeBinding {
    ...
    public ItemSelectMusicPlayerVolumeBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ItemSelectMusicPlayerVolumeBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatImageView) bindings[4], (LinearLayout) bindings[5], (ConstraintLayout) bindings[1], (HorizontalSeekBar) bindings[6], (AppCompatTextView) bindings[7], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[3]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemSelectMusicPlayerVolumeBinding
