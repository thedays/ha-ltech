...
public class ActSearchDeviceBindingImpl extends ActSearchDeviceBinding {
    ...
    public ActSearchDeviceBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private ActSearchDeviceBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ltech.smarthome.databinding.ActSearchDeviceBinding
    ...
    protected void executeBindings() {
        ...
        FtRoomVM ftRoomVM = this.mViewmodel;
        long j2 = j & 6;
        RecyclerView.ItemDecoration itemDecoration = (j2 == 0 || ftRoomVM == null) ? null : ftRoomVM.deviceDecoration;
        if (j2 != 0) {
            ViewAdapter.addItemDecoration(this.rvDevice, itemDecoration);
        }
