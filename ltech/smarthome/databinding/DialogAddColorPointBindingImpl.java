...
public class DialogAddColorPointBindingImpl extends DialogAddColorPointBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.seekbar_duv, 10);
    }

    public DialogAddColorPointBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }

    private DialogAddColorPointBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatEditText) bindings[5], (AppCompatImageView) bindings[6], (ConstraintLayout) bindings[0], (StepSetView) bindings[10], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[7], (AppCompatTextView) bindings[9], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[1], (View) bindings[8]);
        this.etNameandroidTextAttrChanged = new InverseBindingListener() { // from class: com.ltech.smarthome.databinding.DialogAddColorPointBindingImpl.1
            @Override // androidx.databinding.InverseBindingListener
            public void onChange() {
                String textString = TextViewBindingAdapter.getTextString(DialogAddColorPointBindingImpl.this.etName);
                ObservableField<String> observableField = DialogAddColorPointBindingImpl.this.mContent;
    ...
    @Override // com.ltech.smarthome.databinding.DialogAddColorPointBinding
    ...
    */
    protected void executeBindings() {
        ...
        L82:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.databinding.DialogAddColorPointBindingImpl.executeBindings():void");
    }
}