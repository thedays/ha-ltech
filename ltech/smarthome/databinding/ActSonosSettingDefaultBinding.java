...
public abstract class ActSonosSettingDefaultBinding extends ViewDataBinding {
    ...
    @Bindable
    protected ActSonosSettingDefaultVM mViewmodel;
    ...
    public abstract void setViewmodel(ActSonosSettingDefaultVM viewmodel);

    protected ActSonosSettingDefaultBinding(Object _bindingComponent, View _root, int _localFieldCount, AppCompatImageView iv, AppCompatImageView ivDeviceIdGo, AppCompatImageView ivDeviceNameGo, AppCompatImageView ivDistanceGo, AppCompatImageView ivMacAddress, AppCompatImageView ivProductName, AppCompatImageView ivRoomNameGo, AppCompatImageView ivSceneGo, ConstraintLayout layoutChangeRoom, ConstraintLayout layoutDeviceId, ConstraintLayout layoutDeviceName, RelativeLayout layoutMacAddress, RelativeLayout layoutProductName, RelativeLayout layoutSceneAndAutomation, RelativeLayout layoutSensitivity, RelativeLayout layoutUpgrade, SwitchButton sbCrossFade, LayoutTitleDefaultBinding title, AppCompatTextView tvDeleteDevice, AppCompatTextView tvDeviceIdName, AppCompatTextView tvDeviceIdTip, AppCompatTextView tvDeviceName, AppCompatTextView tvNameTip, AppCompatTextView tvRelatedNum, AppCompatTextView tvRoomName, AppCompatTextView tvRoomTip, AppCompatTextView tvUpgradeTip) {
    ...
    public ActSonosSettingDefaultVM getViewmodel() {
        return this.mViewmodel;
    }

    public static ActSonosSettingDefaultBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSonosSettingDefaultBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActSonosSettingDefaultBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_sonos_setting_default, root, attachToRoot, component);
    }

    public static ActSonosSettingDefaultBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSonosSettingDefaultBinding inflate(LayoutInflater inflater, Object component) {
        return (ActSonosSettingDefaultBinding) ViewDataBinding.inflateInternal(inflater, R.layout.act_sonos_setting_default, null, false, component);
    }

    public static ActSonosSettingDefaultBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActSonosSettingDefaultBinding bind(View view, Object component) {
        return (ActSonosSettingDefaultBinding) bind(component, view, R.layout.act_sonos_setting_default);
    }
}