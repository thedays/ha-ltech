...
public abstract class ItemDeviceSuperPanelBinding extends ViewDataBinding {
    ...
    public static ItemDeviceSuperPanelBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSuperPanelBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ItemDeviceSuperPanelBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_super_panel, root, attachToRoot, component);
    }

    public static ItemDeviceSuperPanelBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSuperPanelBinding inflate(LayoutInflater inflater, Object component) {
        return (ItemDeviceSuperPanelBinding) ViewDataBinding.inflateInternal(inflater, R.layout.item_device_super_panel, null, false, component);
    }

    public static ItemDeviceSuperPanelBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ItemDeviceSuperPanelBinding bind(View view, Object component) {
        return (ItemDeviceSuperPanelBinding) bind(component, view, R.layout.item_device_super_panel);
    }
}