...
public class ItemGroupSelectBindingImpl extends ItemGroupSelectBinding {
    ...
    public ItemGroupSelectBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private ItemGroupSelectBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    @Override // com.ltech.smarthome.databinding.ItemGroupSelectBinding
    ...
    protected void executeBindings() {
        ...
        String groupName = ((j & 34) == 0 || group == null) ? null : group.getGroupName();
        long j2 = j & 40;
        if (j2 != 0) {
        ...
        if ((j & 34) != 0) {
            TextViewBindingAdapter.setText(this.tvDeviceName, groupName);
        }
        if ((j & 32) != 0) {
