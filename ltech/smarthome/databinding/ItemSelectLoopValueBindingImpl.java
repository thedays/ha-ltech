...
public class ItemSelectLoopValueBindingImpl extends ItemSelectLoopValueBinding {
    ...
    public ItemSelectLoopValueBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }

    private ItemSelectLoopValueBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (AppCompatImageView) bindings[3], (View) bindings[6], (View) bindings[1], (StepSetView) bindings[7], (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[4], (AppCompatTextView) bindings[5]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.ItemSelectLoopValueBinding
    ...
    protected void executeBindings() {
        ...
        if ((j & 6) != 0) {
            ...
            TextViewBindingAdapter.setText(this.tvSubValue, str);
        }
        if ((j & 4) != 0) {
            ViewAdapter.setTextBold(this.tvName, true);
            ViewAdapter.setTextBold(this.tvSubName, true);
            ViewAdapter.setTextBold(this.tvSubValue, true);
        }
    }
}