...
public class DialogTipBindingImpl extends DialogTipBinding {
    ...
    private DialogTipBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0, (AppCompatTextView) bindings[2], (AppCompatTextView) bindings[3], (AppCompatTextView) bindings[1]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.ltech.smarthome.databinding.DialogTipBinding
