...
public class ActHomeTransferSettingBindingImpl extends ActHomeTransferSettingBinding {
    ...
    public ActHomeTransferSettingBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }

    private ActHomeTransferSettingBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, Object variable) {
        ...
        setViewmodel((ActHomeTransferSettingVM) variable);
        return true;
    }

    @Override // com.ltech.smarthome.databinding.ActHomeTransferSettingBinding
    ...
    @Override // com.ltech.smarthome.databinding.ActHomeTransferSettingBinding
    public void setViewmodel(ActHomeTransferSettingVM Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        ActHomeTransferSettingVM actHomeTransferSettingVM = this.mViewmodel;
        long j2 = 10 & j;
        OnItemBindClass<Object> onItemBindClass2 = null;
        MergeObservableList<Object> mergeObservableList2 = null;
        long j3 = j & 13;
        if (j3 != 0) {
            if (actHomeTransferSettingVM != null) {
                MergeObservableList<Object> mergeObservableList3 = actHomeTransferSettingVM.mergeObservableList;
                onItemBindClass = actHomeTransferSettingVM.itemBinding;
                itemIds2 = actHomeTransferSettingVM.itemIds;
