...
public abstract class FtBindPhoneBinding extends ViewDataBinding {
    ...
    @Bindable
    protected FtBindPhoneVM mViewmodel;
    ...
    public FtBindPhoneVM getViewmodel() {
    ...
    public static FtBindPhoneBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FtBindPhoneBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (FtBindPhoneBinding) ViewDataBinding.inflateInternal(inflater, R.layout.ft_bind_phone, root, attachToRoot, component);
    }

    public static FtBindPhoneBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FtBindPhoneBinding inflate(LayoutInflater inflater, Object component) {
        return (FtBindPhoneBinding) ViewDataBinding.inflateInternal(inflater, R.layout.ft_bind_phone, null, false, component);
    }

    public static FtBindPhoneBinding bind(View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FtBindPhoneBinding bind(View view, Object component) {
        return (FtBindPhoneBinding) bind(component, view, R.layout.ft_bind_phone);
    }
}