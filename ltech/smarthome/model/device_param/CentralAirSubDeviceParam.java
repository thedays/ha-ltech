...
public class CentralAirSubDeviceParam {
    ...
    public CentralAirSubDeviceParam() {
        this.mode = 1;
        this.speed = 1;
    }
    ...
    public CentralAirSubDeviceParam(int unicastAddress, String data, String name, String position) {
        this.mode = 1;
        this.speed = 1;
        LHomeLog.i(CentralAirSubDeviceParam.class, "data=" + data + "__length=" + data.length());
        ...
        if (data.length() >= 16) {
            ...
            LHomeLog.i(CentralAirSubDeviceParam.class, "finalData=" + data + "__length=" + data.length());
            if (data.length() == 20 || data.length() == 22) {
                this.alternate1 = Integer.valueOf(data.substring(16, 18), 16).intValue();
                this.alternate2 = Integer.valueOf(data.substring(18, 20), 16).intValue();
            }
        }
    }
    ...
    public void setAlternate1(int alternate1) {
        this.alternate1 = alternate1;
    }

    public int getAlternate2() {
        return this.alternate2;
    }

    public void setAlternate2(int alternate2) {
        this.alternate2 = alternate2;
    }

    public String toString() {
        return "CentralAirSubDeviceParam{unicastAddress=" + this.unicastAddress + ", outAddr=" + this.outAddr + ", inAddr=" + this.inAddr + ", on=" + this.on + ", temperature=" + this.temperature + ", mode=" + this.mode + ", speed=" + this.speed + ", roomTemp=" + this.roomTemp + ", errorCode=" + this.errorCode + ", alternate1=" + this.alternate1 + ", alternate2=" + this.alternate2 + ", name='" + this.name + "', position='" + this.position + "'}";
    }
}