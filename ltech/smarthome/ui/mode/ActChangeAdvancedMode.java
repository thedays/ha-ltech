...
public class ActChangeAdvancedMode extends BaseRoomDeviceGroupActivity<ActSelect3Binding, FtDeviceGroupVM> {
    ...
    protected void convertView(final BaseViewHolder helper, final Role item) {
        ...
        helper.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.ltech.smarthome.ui.mode.ActChangeAdvancedMode$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActChangeAdvancedMode.this.lambda$convertView$0(item, helper, view);
            }
        });
    }
    ...
    protected void initView() {
        ...
        this.cancelTv.setOnClickListener(new View.OnClickListener() { // from class: com.ltech.smarthome.ui.mode.ActChangeAdvancedMode$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActChangeAdvancedMode.this.lambda$initView$1(view);
            }
        });
    ...
    public void sendModeToList(final Device device) {
        ...
        if (device.isVirtual()) {
            ...
            ReplaceHelper.instance().addBackupData(UpdateBackDataRequest.ADVANCE_MODE, getModeCmdHelper(device, FtAdvancedMode.getObj().getViewModel().zoneNum).saveAdvancedModeInfo(FtAdvancedMode.getObj().getViewModel().modeNum, FtAdvancedMode.getObj().getViewModel().playtime, FtAdvancedMode.getObj().getViewModel().getModeInfo().getInfoList()));
            ReplaceHelper.instance().backupIndexData(this, this.successDeviceIds, FtAdvancedMode.getObj().getViewModel().modeNum);
            return;
        }
        getModeCmdHelper(device, FtAdvancedMode.getObj().getViewModel().zoneNum).saveAdvancedModeInfoInterval(this, FtAdvancedMode.getObj().getViewModel().modeNum, FtAdvancedMode.getObj().getViewModel().playtime, FtAdvancedMode.getObj().getViewModel().getModeInfo().getInfoList(), this.isLast, new IAction() { // from class: com.ltech.smarthome.ui.mode.ActChangeAdvancedMode$$ExternalSyntheticLambda2
            @Override // com.ltech.smarthome.base.IAction
            public final void act(Object obj) {
                ActChangeAdvancedMode.this.lambda$sendModeToList$2(device, (Boolean) obj);
            }
        });
    }
