...
public class ActSelectSwitchConditionAction extends BaseNormalActivity<ActSelectConditionDeviceBinding> implements ISelectAction {
    String deviceName;
    long device_id;
    String floorName;
    ...
    protected void initView() {
        ...
        BaseQuickAdapter<GoItem, BaseViewHolder> baseQuickAdapter = new BaseQuickAdapter<GoItem, BaseViewHolder>(R.layout.item_select, arrayList) { // from class: com.ltech.smarthome.ui.scene.ActSelectSwitchConditionAction.1
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.chad.library.adapter.base.BaseQuickAdapter
            public void convert(BaseViewHolder helper, GoItem item) {
                helper.setText(R.id.tv_name, item.getMainText()).setText(R.id.tv_sub, item.getSubText()).setGone(R.id.tv_sub, !StringUtils.isTrimEmpty(item.getSubText())).setBackgroundRes(R.id.iv_select, helper.getAdapterPosition() == ActSelectSwitchConditionAction.this.selectPosition ? R.mipmap.ic_tick_sel : R.color.transparent);
                ((AppCompatTextView) helper.getView(R.id.tv_name)).getPaint().setFakeBoldText(true);
            }
        };
        this.mAdapter = baseQuickAdapter;
        baseQuickAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() { // from class: com.ltech.smarthome.ui.scene.ActSelectSwitchConditionAction$$ExternalSyntheticLambda0
            @Override // com.chad.library.adapter.base.BaseQuickAdapter.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter2, View view, int i) {
                ActSelectSwitchConditionAction.this.lambda$initView$0(baseQuickAdapter2, view, i);
            }
        });
    ...
    private void setItemData(List<GoItem> mItemAction) {
        ...
        if (this.switch_sum == 1) {
            ...
            } else if (this.productId.equals(ProductId.ID_SMART_PANEL_GQ) || this.productId.equals(ProductId.ID_SMART_PANEL_GQX)) {
                stringArray = getResources().getStringArray(R.array.gq_condition);
            } else {
        ...
        if (this.switch_sum == 12) {
            stringArray = getResources().getStringArray(R.array.key12_switch_click_condition);
        }
        ...
        if (this.switch_sum < 15) {
            if (this.productId.equals(ProductId.ID_SMART_SWITCH_SQ) || this.productId.equals(ProductId.ID_SMART_SWITCH_SQB) || this.productId.equals(ProductId.ID_SMART_SWITCH_SQ_PRO)) {
                ...
                if (i2 == 0) {
                    ...
                    deviceConditionParam.index = 7;
                } else if (i2 == 4) {
                    deviceConditionParam.index = 11;
                } else if (i2 == 5) {
                    deviceConditionParam.index = 12;
                }
            } else {
                deviceConditionParam.type = 1;
