...
public class ActProjector extends BaseActTv<ActProjectorVM> {
    ...
    public ActProjectorVM getViewModel() {
        return (ActProjectorVM) new ViewModelProvider(this).get(ActProjectorVM.class);
    }
    ...
    protected void initView() {
        super.initView();
        ((ActTvBinding) this.mViewBinding).ivHome.setImageResource(R.mipmap.icon_ir_menu);
    }
}