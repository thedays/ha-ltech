...
public class ActStbVM extends BaseTvVM {
    private static final int[] existFun = {1, 116, 146, 45, 43, 44, 50, 51, 42, 47, 48, 49, 46, 56, 61, 66, 71, 76, 81, 86, 91, 96, 101};
    ...
    protected Fragment createFunFragment() {
        return FtTvFun.newInstance(ActStbVM.class);
    }

    @Override // com.ltech.smarthome.ui.device.ir.BaseTvVM
    protected Fragment createNumFragment() {
        return FtTvNum.newInstance(ActStbVM.class);
    }

    @Override // com.ltech.smarthome.ui.device.ir.BaseTvVM
    protected Fragment createExtFunFragment() {
        return FtExtFun.newInstance(ActStbVM.class);
    }
    ...
    protected BindingCommand<View> getViewClick() {
        return new BindingCommand<>(new BindingConsumer() { // from class: com.ltech.smarthome.ui.device.ir.ActStbVM$$ExternalSyntheticLambda0
            @Override // com.ltech.smarthome.binding.command.BindingConsumer
            public final void call(Object obj) {
                ActStbVM.this.lambda$getViewClick$0((View) obj);
            }
        });
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_home /* 2131297093 */:
                ...
                if (queryByteArrayValue == null) {
                    ...
                    showLoadingDialog();
                    this.mIrCmdParam = CmdAssistant.getGatewayAssistant(this.controlDevice.getValue(), new int[0]).sendIrComboControl(ActivityUtils.getTopActivity(), this.mParams, queryByteArrayValue, new IAction<Boolean>() { // from class: com.ltech.smarthome.ui.device.ir.ActStbVM.1
                        @Override // com.ltech.smarthome.base.IAction
                        public void act(Boolean aBoolean) {
                            ActStbVM.this.dismissLoadingDialog();
                            if (aBoolean.booleanValue()) {
                                return;
                            }
                            ActStbVM.this.showErrorTipDialog(ActivityUtils.getTopActivity().getString(R.string.app_str_control_timeout));
                        }
                    }, !this.selectAction);
                    clickAnimate(view);
                    break;
