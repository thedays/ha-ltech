...
public class ActProjectorVM extends BaseTvVM {
    private static final int[] existFun = {1, 116, 45, IrKeyRepository.ID_ZOOM_UP, IrKeyRepository.ID_ZOOM_DOWN, 50, 51, 42, 47, 48, 49, 46, 56, 61, 66, 71, 76, 81, 86, 91, 96, 101};

    @Override // com.ltech.smarthome.ui.device.ir.BaseTvVM
    protected Fragment createFunFragment() {
        return FtTvFun.newInstance(ActProjectorVM.class);
    }

    @Override // com.ltech.smarthome.ui.device.ir.BaseTvVM
    protected Fragment createNumFragment() {
        return FtTvNum.newInstance(ActProjectorVM.class);
    }

    @Override // com.ltech.smarthome.ui.device.ir.BaseTvVM
    protected Fragment createExtFunFragment() {
        return FtExtFun.newInstance(ActProjectorVM.class);
    }
    ...
    protected BindingCommand<View> getViewClick() {
        return new BindingCommand<>(new BindingConsumer() { // from class: com.ltech.smarthome.ui.device.ir.ActProjectorVM$$ExternalSyntheticLambda0
            @Override // com.ltech.smarthome.binding.command.BindingConsumer
            public final void call(Object obj) {
                ActProjectorVM.this.lambda$getViewClick$0((View) obj);
            }
        });
    }
