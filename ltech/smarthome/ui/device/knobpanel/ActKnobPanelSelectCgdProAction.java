...
import com.ltech.smarthome.ui.scene.ActSelectDaliLightGroupForAction;
...
public class ActKnobPanelSelectCgdProAction extends BaseNormalActivity<ActSelectBinding> implements ISelectAction {
    ...
    protected void initView() {
        ...
        SceneHelper.instance().bindingType = 3;
        arrayList.add(new GoItem().setMainText(getString(R.string.dali_group)).setAction(new BindingCommand(new BindingAction() { // from class: com.ltech.smarthome.ui.device.knobpanel.ActKnobPanelSelectCgdProAction$$ExternalSyntheticLambda0
            @Override // com.ltech.smarthome.binding.command.BindingAction
            public final void call() {
                ActKnobPanelSelectCgdProAction.this.lambda$initView$0();
            }
        })));
        arrayList.add(new GoItem().setMainText(getString(R.string.dali_light)).setAction(new BindingCommand(new BindingAction() { // from class: com.ltech.smarthome.ui.device.knobpanel.ActKnobPanelSelectCgdProAction$$ExternalSyntheticLambda1
            @Override // com.ltech.smarthome.binding.command.BindingAction
            public final void call() {
                ActKnobPanelSelectCgdProAction.this.lambda$initView$1();
            }
        })));
        BaseQuickAdapter<GoItem, BaseViewHolder> baseQuickAdapter = new BaseQuickAdapter<GoItem, BaseViewHolder>(this, R.layout.item_go_1, arrayList) { // from class: com.ltech.smarthome.ui.device.knobpanel.ActKnobPanelSelectCgdProAction.1
        ...
        baseQuickAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() { // from class: com.ltech.smarthome.ui.device.knobpanel.ActKnobPanelSelectCgdProAction$$ExternalSyntheticLambda2
            @Override // com.chad.library.adapter.base.BaseQuickAdapter.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter2, View view, int i) {
                ActKnobPanelSelectCgdProAction.this.lambda$initView$2(baseQuickAdapter2, view, i);
            }
        });
