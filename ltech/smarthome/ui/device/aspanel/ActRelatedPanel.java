...
public class ActRelatedPanel extends BaseSelectDeviceActivity {
    ...
    protected void initView() {
        super.initView();
        this.mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda2
            @Override // com.chad.library.adapter.base.BaseQuickAdapter.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                ActRelatedPanel.this.lambda$initView$0(baseQuickAdapter, view, i);
            }
        });
    }
    ...
    protected void startObserve() {
        ...
        handleData(this.deviceResult, new IAction() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda0
            @Override // com.ltech.smarthome.base.IAction
            public final void act(Object obj) {
                ActRelatedPanel.this.lambda$startObserve$1(longExtra, (List) obj);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$startObserve$1(long j, List list) {
        ...
        while (it.hasNext()) {
            ...
            if (productInfoByPid != null && "04".equalsIgnoreCase(productInfoByPid.getProductKey())) {
    ...
    protected void edit() {
        ...
        if (Injection.state().isConnectOuterNet()) {
            ...
            CmdAssistant.getSettingCmdAssistant(null, new int[0]).subscribe(this, unicastAddress, publicationAddress, ProductRepository.getAgreementIdByPid(device.getProductId()), 1 << this.relatePosition, 0, new IAction() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda1
                @Override // com.ltech.smarthome.base.IAction
                public final void act(Object obj) {
                    ActRelatedPanel.this.lambda$edit$2((Boolean) obj);
                }
            });
            return;
        }
    ...
    private void uploadData() {
        ((ObservableSubscribeProxy) Injection.net().updateParamExt(this.controlDevice.getDeviceId(), this.relateInfoAssistant.getExtParamString()).compose(RxUtils.io_main()).doOnSubscribe(new Consumer() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ActRelatedPanel.this.lambda$uploadData$3((Disposable) obj);
            }
        }).doFinally(new Action() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda4
            @Override // io.reactivex.functions.Action
            public final void run() {
                ActRelatedPanel.this.dismissLoadingDialog();
            }
        }).as(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(this, Lifecycle.Event.ON_DESTROY)))).subscribe(new Consumer() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel$$ExternalSyntheticLambda5
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ActRelatedPanel.this.lambda$uploadData$4(obj);
            }
    ...
    private void showFailDialog() {
        runOnUiThread(new Runnable() { // from class: com.ltech.smarthome.ui.device.aspanel.ActRelatedPanel.1
            @Override // java.lang.Runnable
            public void run() {
                ViewHelpUtil.showBindFailDialog(ActRelatedPanel.this);
            }
        });
    }
}