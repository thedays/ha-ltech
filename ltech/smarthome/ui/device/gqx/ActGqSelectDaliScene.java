...
public class ActGqSelectDaliScene extends VMActivity<ActDaliSelectBinding, ActSmartPanelSelectActionVM> {
    ...
    protected void initView() {
        ...
        ((ActDaliSelectBinding) this.mViewBinding).tvBottom.setOnClickListener(new View.OnClickListener() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActGqSelectDaliScene.this.lambda$initView$0(view);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$initView$0(View view) {
        ...
        bindData(this.ftScene.getSelectSceneList().get(0).getSceneId(), 3);
    }
    ...
    private void bindData(final long relateId, final int relateType) {
        ...
        ImageTipDialog.asDefault().setTitle(getString(R.string.app_str_rc4s_activate_tip)).setConfirmString(getString(R.string.get_it)).setImageRes(R.mipmap.rc4sble_2).setCallback(new ImageTipDialog.OnConfirmCallback() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda6
            ...
            public final void onConfirmClick(ImageTipDialog imageTipDialog) {
                ActGqSelectDaliScene.this.lambda$bindData$1(relateType, relateId, deviceById, intExtra, imageTipDialog);
            }
        }).showDialog(this);
    }
    ...
    */
    public /* synthetic */ void lambda$bindData$1(final int r12, final long r13, final com.ltech.smarthome.model.bean.Device r15, final int r16, final com.ltech.smarthome.view.dialog.ImageTipDialog r17) {
        ...
        L62:
            ...
            com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$1 r1 = new com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$1
            r2 = r11
            r9 = r12
            r7 = r13
            r3 = r15
        ...
        L81:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene.lambda$bindData$1(int, long, com.ltech.smarthome.model.bean.Device, int, com.ltech.smarthome.view.dialog.ImageTipDialog):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void showFailBindDialog(final long relateId, final int relateType) {
        MessageDialog.show(this, getString(R.string.app_str_operation_failure), getString(R.string.app_str_binding_fail_tip)).setCancelable(false).setOkButton(getString(R.string.go_continue), new OnDialogButtonClickListener() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda0
            @Override // com.smart.dialog.interfaces.OnDialogButtonClickListener
            public final boolean onClick(BaseDialog baseDialog, View view) {
                boolean lambda$showFailBindDialog$2;
                lambda$showFailBindDialog$2 = ActGqSelectDaliScene.this.lambda$showFailBindDialog$2(relateId, relateType, baseDialog, view);
                return lambda$showFailBindDialog$2;
            }
        }).setCancelButton(ActivityUtils.getTopActivity().getString(R.string.cancel), new OnDialogButtonClickListener() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda1
            @Override // com.smart.dialog.interfaces.OnDialogButtonClickListener
            public final boolean onClick(BaseDialog baseDialog, View view) {
                return ActGqSelectDaliScene.lambda$showFailBindDialog$3(baseDialog, view);
            }
        });
    }
    ...
    public void uploadData(Device device, final int selIndex, final long relateId, final int relateType) {
        ((ObservableSubscribeProxy) Injection.net().bindKeyInfo(device.getDeviceId(), ComboCmdHelper.getInstance().getKeysByZone(selIndex + 1)).compose(RxUtils.io_main()).doOnSubscribe(new Consumer() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda3
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ActGqSelectDaliScene.this.lambda$uploadData$4((Disposable) obj);
            }
        }).doFinally(new Action() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda4
            @Override // io.reactivex.functions.Action
            public final void run() {
                ActGqSelectDaliScene.this.dismissLoadingDialog();
            }
        }).as(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(this, Lifecycle.Event.ON_DESTROY)))).subscribe(new Consumer() { // from class: com.ltech.smarthome.ui.device.gqx.ActGqSelectDaliScene$$ExternalSyntheticLambda5
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
                ActGqSelectDaliScene.this.lambda$uploadData$5(selIndex, relateId, relateType, (List) obj);
            }
