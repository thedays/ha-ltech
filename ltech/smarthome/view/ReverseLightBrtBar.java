...
public class ReverseLightBrtBar extends ReversedSeekBar {
    private boolean isIncludeZero;
    private int minProgressValue;

    public ReverseLightBrtBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.isIncludeZero = false;
    }

    public ReverseLightBrtBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.isIncludeZero = false;
    }

    public ReverseLightBrtBar(Context context) {
        super(context);
        this.isIncludeZero = false;
    }
    ...
    public void setOnSeekBarChangeListener(final SeekBar.OnSeekBarChangeListener l) {
        super.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.ltech.smarthome.view.ReverseLightBrtBar.1
            @Override // android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (l != null) {
                    if (!ReverseLightBrtBar.this.isIncludeZero()) {
    ...
    */
    public synchronized void setProgress(int r3) {
        ...
        L48:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ltech.smarthome.view.ReverseLightBrtBar.setProgress(int):void");
    }
