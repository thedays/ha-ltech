...
print("\n" + "=" * 80)
print("Try with appid as integer")
print("=" * 80)
...
print(f"Request JSON: {request_json2}")

response2 = requests.post(f"{SERVER_URL}{REST_URL}", data=request_json2, headers={"Content-Type": "application/json"}, verify=False, timeout=30)
print(f"\nResponse:")
