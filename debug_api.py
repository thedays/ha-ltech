...
def test_login(email, password):
    ...
    print("TEST: Login")
    print("=" * 70)
    print(f"Login data (before encryption):")
    print(json.dumps(login_data, separators=(',', ':')))
...
def test_encryption():
    ...
    encrypted = aes_encrypt_cbc(test_data, SECRET_KEY_DEFAULT)
    print(f"Encrypted (CBC): {encrypted}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 3:
        ...
        print("\nTo test login, run:")
        print("python debug_api.py <email> <password>")