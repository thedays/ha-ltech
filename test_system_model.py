...
def test_login(account, password):
    ...
    for model in system_models:
        print(f"\nTesting system_model: '{model}'")
        result = _send_request(SERVER_URL, SESSION_DEFAULT, FUN_URL_LOGIN, login_data, model)
...
if __name__ == "__main__":
    if len(sys.argv) >= 3:
        ...
        print("Usage: python test_system_model.py <account> <password>")